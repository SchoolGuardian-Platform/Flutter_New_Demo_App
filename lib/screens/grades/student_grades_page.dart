    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            _ScaleRow(grade: 'A', range: '86% - 100%', points: '4.0'),
            _ScaleRow(grade: 'B+', range: '76% - 85%', points: '3.5'),
            _ScaleRow(grade: 'B', range: '66% - 75%', points: '3.0'),
            _ScaleRow(grade: 'C+', range: '56% - 65%', points: '2.5'),
            _ScaleRow(grade: 'C', range: '46% - 55%', points: '2.0'),
            _ScaleRow(grade: 'D', range: '40% - 45%', points: '1.0'),
